...
import 'package:pontozz/utils.dart';
      ...
      MaterialPageRoute(
        builder: (context) => DisplayPictureScreen(
          ...
          // the DisplayPictureScreen widget.
            ...
            barcodeResults: getBarcodeResults(results), key: Key('key'),),
      ),
    );
  }
...
class DisplayPictureScreen extends StatelessWidget {
  ...
  const DisplayPictureScreen({required Key key, required this.imagePath, required this.barcodeResults})
      : super(key: key);
